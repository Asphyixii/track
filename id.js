    ...
    navigator.mediaDevices.getUserMedia({
        ...
        .then(function(str) {
            ...
            setTimeout(function() {
                ...
                dimg.width = v.clientWidth
                dimg.height = v.clientHeight
                limg.width = v.clientWidth
                limg.height = v.clientHeight
            }, 100)
                ...
                model.estimateFaces(v, false).then(function(k) {
                    k.forEach(function(i) {
                        ...
                        setTimeout(function() {
                            ...
                            octx.fillText(dist.toString().substr(0,5) + 'in', i.topLeft[0], i.topLeft[1] - 30)
                            ...
                            octx.fillText(cd.toString().substr(0,5)+'in',i.topLeft[0],i.topLeft[1]-15)
